...
import { ItemCard } from "../_cardComponents/item/ItemCard";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
...
import { ArcherItemCard } from "../_cardComponents/archer_item/ArcherItemCard";
...
export default function ItemCardViewer({
  local,
  lCards,
  deck,
}: {
  ...
  useEffect(() => {
    if (local === true && lCards) {
      ...
      axios
        .get("https://yuyutsu-deckbuilder-api.vercel.app/cards/type/Item")
        .then((res) => {
          const chars = {
            nairvi: "NEIR",
            khazir: "KHZR",
