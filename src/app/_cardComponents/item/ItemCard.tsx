...
export const ItemCard = ({name, primaryClass, secondaryClass, thirdClass, text, cost, effectBack, cardId, cardImg }:ICard) => {
          ...
          <div className="relative h-[252px] overflow-hidden bg-cover" style={{ backgroundImage: `url('/Images/${cardImg}')` }}>
            ...
            <div className="absolute w-[165px] h-[87px] top-[5px] left-2.5">
              <Image
                ...
                height={19}
              />
              <div className="absolute w-5 h-[11px] top-[9px] left-[7px] [font-family:'Oswald',Helvetica] font-bold text-[#3d3631] text-[11px] tracking-[0] leading-[11px]">
                ITEM
              </div>
